local mod_settings_prefix = "auto_wand_edit."
...
local transl_key_prefix = "$auto_wand_edit_"
...
function center_text( text )
	return GuiGetTextDimensions( not_a_gui, text, 1, 0, "mods/auto_wand_edit/files/font/font_small_numbers.xml", true ) / 2
end
