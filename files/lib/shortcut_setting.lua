local smallfolk = dofile_once( "mods/auto_wand_edit/files/lib/smallfolk.lua" )
dofile_once( "mods/auto_wand_edit/files/lib/shortcut_tostring.lua" )
dofile_once( "mods/auto_wand_edit/files/gui/keyboard_listener.lua" )
local KEYCODES_RAW = dofile_once( "mods/auto_wand_edit/files/lib/keycodes_wrapped.lua" )[1]
