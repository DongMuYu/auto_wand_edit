function freeze_controls()
	for _, player in ipairs( EntityGetWithTag( "player_unit" ) or {} ) do
		local controls_disabler = EntityCreateNew()
		EntityAddTag( controls_disabler, "auto_wand_edit_controls_disabler" )
		EntityAddTag( controls_disabler, "auto_wand_edit_non_toxic_status" )
...
function unfreeze_controls()
	for _, controls_disabler in ipairs( EntityGetWithTag( "auto_wand_edit_controls_disabler" ) ) do
